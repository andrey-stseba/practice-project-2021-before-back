...
import styles from './FooterRegistrationPage.module.sass'
import textArticlesFooter from './textArticlesFooter.json'

function FooterRegistrationPage () {
  return (
    <div className={styles.articlesMainContainer}>
      {textArticlesFooter.map((col, i) => (
...
export default FooterRegistrationPage
